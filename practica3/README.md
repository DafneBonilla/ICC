...
### Fecha de entrega: martes 26 de octubre, 2021

Al igual que en la práctica anterior, deben implementar los métodos faltantes de
la clase
[ListaEstudiante](https://aztlan.fciencias.unam.mx/gitlab/2022-1-icc/practica3/-/blob/main/src/main/java/mx/unam/ciencias/icc/ListaEstudiante.java).
...
[Practica3](https://aztlan.fciencias.unam.mx/gitlab/2022-1-icc/practica3/-/blob/main/src/main/java/mx/unam/ciencias/icc/Practica3.java)
al hacer:
...
```
$ git clone https://canek@aztlan.fciencias.unam.mx/gitlab/2022-1-icc/practica3.git
```
...
3](https://aztlan.fciencias.unam.mx/~canek/2022-1-icc/practica3/apidocs/index.html)
